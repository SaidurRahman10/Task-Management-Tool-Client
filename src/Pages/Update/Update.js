    ...
    <div className="h-[100vh]">
      <div className="lg:w-[33rem] mx-auto mt-16 shadow-2xl p-10 bg-slate-100 bg-opacity-25 rounded-lg ">
        ...
        <form onSubmit={handleSubmit(handelUpdateTask)}>
          ...
          <input
            className="bg-green-500 text-white  px-5 py-2 rounded-xl hover:border hover:bg-white hover:text-black hover:border-text-600 hover:font-semibold duration-300 transform  mt-4"
            value="Update Task"
            type="submit"
          />
