    ...
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-10 border-0 ">
      ...
      <>
       <Typography
        ...
        className="p-1 font-normal"
      >
        <Link to='/mytask'  className="flex items-center hover:text-lg duration-300 transform bg-slate-600 text-white px-3 rounded-md py-2 font-bold hover:bg-white   hover:text-slate-600">
      ...
      <Typography
        ...
        className="p-1 font-normal"
      >
        <Link to='/completedtask'  className="flex items-center hover:text-lg duration-300 transform bg-slate-600 text-white px-3 rounded-md hover:bg-white   hover:text-slate-600 py-2 font-bold ">
